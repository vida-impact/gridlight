...
class Configuration_1(DefaultDataConfiguration):
    """
...
class __ConfigurationProvider_1(ConfigProviderBase[Configuration_1]):
    pass

_config_provider_1 = __ConfigurationProvider_1()

def get_config_1(reload=False) -> Configuration_1:
    return _config_provider_1.get_config(reload)
