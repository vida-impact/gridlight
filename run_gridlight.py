...
from src.gridlight.prepare import (drop_zero_pop, merge_rasters, prepare_ntl,
                                   prepare_roads)
from src.gridlight.util.loading import open_raster_in_tar, open_raster_files
...
def run_gridfinder(
    ...
    if dev_mode:
        remote_storage = get_develop_remote_storage(d)
    else:
        remote_storage = get_default_remote_storage(d)
